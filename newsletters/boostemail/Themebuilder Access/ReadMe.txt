...
Thanks for purchasing Appalache - Winter Tourism & Ski Resort Email. Below is the Link for ThemeBuilder to access and customise & edit your email template on the fly.
...
Direct Access of Builder: http://emailbuilder-v3.theemon.com/boost_event/layout-1

URL To Generate Event Counter: https://motionmailapp.com

Note: Generate the Image from there & replace path using HTML Editor.

Code: <img src="http://s.mmgo.io/t/ZZH" alt="motionmailapp.com" width="500" height="110" class="img-resize"  />

Here replace http://s.mmgo.io/t/ZZH to newer one generated by you.
